...
export const VehiclesForm = ({
	...
	const initialValues: IinitialValues = {
		...
		RegoDue: vehicleData?.RegoDue || moment().format('DD/MM/YYYY'),
		WOFDate: vehicleData?.WOFDate || moment().format('DD/MM/YYYY'),
		ServiceDueDate:
			vehicleData?.ServiceDueDate || moment().format('DD/MM/YYYY'),
		...
		Date: vehicleData?.Date || moment().format('DD/MM/YYYY'),
