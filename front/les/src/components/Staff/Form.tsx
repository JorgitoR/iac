...
import { NextOfKin } from './FormComponents/NextOfKin'
import { ScaffoldCertificate } from './FormComponents/ScaffoldCertificate'
...
export const StaffForm = ({
	...
	const initialValues: IStaffRow = {
		...
		next_of_kin_email: data?.employement_contract || '',

		scaffold_certificate_photo: data?.scaffold_certificate_photo || '',
	}
