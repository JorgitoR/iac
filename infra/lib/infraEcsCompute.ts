    ...
    constructor(scope?: Construct, id?: string, props?: cdk.StackProps){
        ...
        if (process.env.S3 && process.env.S3_NAME) {
            ...
            s3Bucket.addToResourcePolicy(new iam.PolicyStatement({
				...
				effect: iam.Effect.ALLOW,
				principals: [new iam.ArnPrincipal('arn:aws:iam::489213602161:user/Github_actions')],
                actions: [
                    "s3:PutObject",
                    "s3:GetObject",
                    "s3:DeleteObject",
        ...
        const containerEc2 = taskDefinition.addContainer(String(process.env.ECR_REPOSITORY), {
            ...
            environment: {
                ...
                AWS_S3_BUCKET_NAME: String(process.env.S3_NAME),
                AWS_SECRET_KEY: String(process.env.AWS_SECRET_KEY_CLOUD),
                AWS_ACCESS_KEY: String(process.env.AWS_ACCESS_KEY_ID_CLOUD)
            },
        });
